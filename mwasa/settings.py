...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='http://127.0.0.1,http://localhost', cast=lambda v: [s.strip() for s in v.split(',')])
...
# Cache settings (basic file-based cache for development)
CACHES = {
    'default': {
